...
export function MainSlideBlock(props: SlideBlockProps) {
    ...
    if (props.block.type === 'text') {
        svgElem = <TextBlock textBlock={props.block} isSmallElem={false}/>
    }
    if (props.block.type === 'image') {
        svgElem = <ImageBlock imageBlock={props.block} isSmallElem={false}/>
    }
    if (props.block.type === 'graphic') {
        svgElem = <GraphBlock graphBlock={props.block} isSmallElem={false}/>
    }
    return svgElem;
}